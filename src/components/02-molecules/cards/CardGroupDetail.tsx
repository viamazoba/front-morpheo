            ...
            <div>
                <div className="grid grid-cols-2 gap-3">
                    <p className="font-semibold text-principal-180">
                        Estudiantes:&nbsp;
                        <span className="font-normal text-principal-350">23</span>
                    </p>
                    <p className="font-semibold text-principal-180">
                        Año:&nbsp;
                        <span className="font-normal text-principal-350">2024</span>
                    </p>
                </div>
                <div className="my-2 relative">
                    <p className="flex font-semibold text-principal-180 mb-1">
                        Test Realizados&nbsp;(0)
                        <ChevronDownIcon
                            className={`text-principal-350  cursor-pointer rounded ml-1 p-0.5 w-6 h-auto hover:bg-principal-100 hover:text-principal-150 ${isTestVisible && 'rotate-180'}`}
                ...
                <div className="my-2 relative">
                    <p className="flex font-semibold text-principal-180">
                        Test Asignados&nbsp;(1)
                        <ChevronDownIcon
                            className={`text-principal-350  cursor-pointer rounded ml-1 p-0.5 w-6 h-auto hover:bg-principal-100 hover:text-principal-150 ${isAssigmentsVisible && 'rotate-180'}`}
